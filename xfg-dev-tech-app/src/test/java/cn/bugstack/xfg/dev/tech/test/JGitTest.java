...
public class JGitTest {
    ...
    public void test() throws IOException, GitAPIException {
        // 这部分替换为你的
        String repoURL = "https://gitcode.com/DDDDSSSSCCCC/xfg-dev-tech-http";
        String username = "DDDDSSSSCCCC";
        String password = "Ykh4v36gfya4_-4DdiHdzHp6";
